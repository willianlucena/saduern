...
class PermissaoController {
	...
	def list = {
		...
		[authorityList: Permissao.list(params)]
	}
	 ...
	 */
	def show = {
		def authority = Permissao.get(params.id)
		if (!authority) {
			flash.message = "Permissao not found with id $params.id"
	...
	def delete = {
		...
		flash.message = "Permissao $params.id deleted."
		redirect action: list
	}
